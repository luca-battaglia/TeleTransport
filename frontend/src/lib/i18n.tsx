...
const en: Translations = {
  ...
  swap_btn: "Swap",
  dates_label: "Departure dates",
  dates_placeholder: "Select departure dates",
  ...
  err_no_dates: "Pick at least one departure date.",
  err_past_dates: "Some of the selected dates are in the past. Pick today or a later day.",
  err_too_many_route_days: "This search covers {route_days} route-days (origins × destinations × days), and the limit is {max}. Remove a place or some days.",
  ...
  err_demo_search_too_large: "Demo searches cover up to {days} days. Add your own SerpApi key in Settings for bigger searches.",
  ...
  demo_banner: "No SerpApi key set: flight searches run on a shared demo quota ({left} left today), limited to one route and up to 3 days. Add your own free key in Settings for full searches.",
  ...
  iata_mapping: "IATA Codes Mapping (one per line, e.g. linate=LIN, or rome=FCO,CIA for every airport of a city)",
  save_settings: "Save Settings",
  saved_local: "Saved in this browser",
  save_failed: "Not saved: this browser's storage is full or turned off.",
  language: "Language",
  language_en: "English",
...
const it: Translations = {
  ...
  guide_date_pool_desc: "Seleziona un intervallo, poi premi il bottone col calendario e il più accanto al campo per memorizzarlo e continuare a scegliere. Ogni intervallo memorizzato diventa un chip sotto il campo, che puoi togliere con la sua ×, e il campo resta libero per un altro intervallo. È così che cerchi per esempio dal 24 al 26 agosto insieme al 31 agosto - 2 settembre in una sola ricerca, saltando i giorni in mezzo. Una ricerca può coprire al massimo 14 giorni in totale sommando tutti i suoi intervalli, e al massimo 30 combinazioni di tratta e giorno (origini × destinazioni × giorni): due destinazioni per 14 giorni ci stanno, tre no.",
  ...
  swap_btn: "Inverti",
  dates_label: "Date di partenza",
  dates_placeholder: "Seleziona le date di partenza",
  ...
  err_no_dates: "Scegli almeno una data di partenza.",
  err_past_dates: "Alcune delle date scelte sono già passate. Scegli oggi o un giorno successivo.",
  err_too_many_route_days: "Questa ricerca copre {route_days} combinazioni di tratta e giorno (origini × destinazioni × giorni), e il limite è {max}. Togli un luogo o qualche giorno.",
  ...
  err_demo_search_too_large: "Le ricerche demo coprono fino a {days} giorni. Aggiungi la tua API key di SerpApi nelle Impostazioni per ricerche più ampie.",
  ...
  demo_banner: "Nessuna API key di SerpApi: le ricerche di voli usano una quota demo condivisa ({left} rimaste oggi), limitata a una tratta e a 3 giorni. Aggiungi la tua chiave gratuita nelle Impostazioni per le ricerche complete.",
  ...
  iata_mapping: "Mappatura Codici IATA (uno per riga, es. linate=LIN, oppure roma=FCO,CIA per tutti gli aeroporti di una città)",
  save_settings: "Salva Impostazioni",
  saved_local: "Salvato in questo browser",
  save_failed: "Non salvato: lo spazio del browser è pieno o disattivato.",
  language: "Lingua",
  language_en: "English",
  language_it: "Italiano",
